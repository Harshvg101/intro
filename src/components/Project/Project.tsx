          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Architechs-IITGOA/cepheus23_android_app " target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://play.google.com/store/apps/details?id=com.iitgoacepheustwth.cepheus23&hl=en-IN" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Android Application for managing University Events</h3>
              <p> Created an Android App for Event Management and Candidate registrations
for Technical Fest of IIT Goa using Kotlin, Firebase, PosgreSQL, NodeJS, AWS</p>
<p>
Got 3000+ registrations through App and 900+ downloads. </p>
            </div>
            <footer> <ul className="tech-list"> <li>AWS</li> <li>Kotlin</li> <li>NodeJS</li> <li>API Gateway</li> <li>Firebase</li> <li>PosgtreSQL</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Harshvg101/Recordlinkage-with-UI/tree/main" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://github.com/Harshvg101/Recordlinkage-with-UI/tree/main" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>RecordLinkage: </h3>
              <p>
                Developed end to end Record Linkage System with UI for matching records from two datasets using Python, Flask, and RecordLinkage library. Implemented data preprocessing, feature engineering, and supervised learning techniques to achieve high accuracy in record matching.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Architechs-IITGOA/AutoRefreshForticlient" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Auto Refresh Forti-Client</h3>
              <p>
              Utility android app to automate User Authentication on Firewall which was supposed to be done every 3 hours.
              </p>
              <p>
              Used app foreground and background services, reverse-engineered Firewall authentication system 
              </p>
            </div>
            <footer>
              <ul className="tech-list">
